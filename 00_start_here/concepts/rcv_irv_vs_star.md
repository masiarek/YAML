...
- [Center squeeze](./center_squeeze.md) · [Monotonicity](./monotonicity.md) · [Summability](./summability.md)
- [Exhausted ballots](./RCV_IRV/RCV_IRV_exhausted_ballots.md) · [Residual vote-splitting](./residual_vote_splitting.md)
- [Is RCV "simple"?](./is_rcv_simple.md) · [Is IRV "just plurality"?](./irv_and_plurality.md)
