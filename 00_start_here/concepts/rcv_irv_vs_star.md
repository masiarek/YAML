...
- [Center squeeze](RCV_IRV/center_squeeze.md) · [Monotonicity](RCV_IRV/RCV_IRV_non_monotonicity.md) · [Summability](STAR_Voting/STAR_summability.md)
