...
- **Equal Support / Equal Preference** — scoring two candidates the same; counts as "no preference" between them in the runoff. → demo [`equal_support_runoff_demo.yaml`](../01_Single_winner/equal_support_runoff_demo.yaml); episode [`are_equal_score_votes_discounted.md`](../interviews_conversations/are_equal_score_votes_discounted.md)
...
- **Center squeeze** — a broadly-liked moderate eliminated early for lacking first-choice support; an RCV-IRV failure STAR avoids. → page [`concepts/center_squeeze.md`](./concepts/center_squeeze.md); demos: RCV-IRV [`squeeze`](../01_Single_winner/center_squeeze_irv.yaml) / STAR [`fix`](../01_Single_winner/center_squeeze_star.yaml)
...
- **Monotonicity** — raising a candidate on your ballot never causes them to lose (and vice versa). → page [`concepts/monotonicity.md`](./concepts/monotonicity.md); demos: RCV-IRV [`before`](../01_Single_winner/monotonicity_irv_before.yaml)/[`after`](../01_Single_winner/monotonicity_irv_after.yaml) (X loses), STAR [`before`](../01_Single_winner/monotonicity_star_before.yaml)/[`after`](../01_Single_winner/monotonicity_star_after.yaml) (X holds)
...
- **Summability / precinct-summable** — results can be computed by adding independent precinct totals (STAR can; RCV-IRV cannot). → page [`concepts/summability.md`](./concepts/summability.md); demo [`04b_c4_b3_display-options-all.yaml`](../01_Single_winner/04b_c4_b3_display-options-all.yaml)
...
- **Bloc STAR** — multi-winner STAR that elects the top N candidates (at-large / majoritarian). → demo [`01_c4_b2_bloc-star-2-seats.yaml`](../02_Multi_winner/01_c4_b2_bloc-star-2-seats.yaml); [`CURRICULUM.md`](./CURRICULUM.md) (201.5)
- **Proportional STAR** — multi-winner methods (Reweighted Range Voting, Allocated Score, Sequentially Spent Score) that give proportional representation. → demos [`02_Multi_winner/`](../02_Multi_winner/); [`CURRICULUM.md`](./CURRICULUM.md) (301.1)
