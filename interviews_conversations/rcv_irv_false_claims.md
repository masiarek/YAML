...
| "RCV is **as easy as 1-2-3** / simple." | **Half-true** | The *ballot* is simple to mark; the *count* is rounds of eliminate-and-transfer — not summable, needs a central tally and software. | [`../00_start_here/concepts/is_rcv_simple.md`](../00_start_here/concepts/RCV_IRV/is_rcv_simple.md) · [`tabulation_star_vs_irv.md`](../00_start_here/concepts/tabulation_star_vs_irv.md) |
...
- [`favorite_betrayal_voting_301.md`](./favorite_betrayal_voting_301.md) — "safe to vote
  your conscience."
- [`../00_start_here/concepts/is_rcv_simple.md`](../00_start_here/concepts/RCV_IRV/is_rcv_simple.md)
