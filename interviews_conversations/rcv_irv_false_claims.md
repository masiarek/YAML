...
| "RCV is **as easy as 1-2-3** / simple." | **Half-true** | The *ballot* is simple to mark; the *count* is rounds of eliminate-and-transfer — not summable, needs a central tally and software. | [`../00_start_here/concepts/RCV_IRV_is_simple.md`](../00_start_here/concepts/RCV_IRV/RCV_IRV_is_simple.md) · [`tabulation_star_vs_irv.md`](../00_start_here/concepts/tabulation_star_vs_irv.md) |
| "RCV is **non-polarizing** / elects the consensus candidate." | **Oversold** | IRV **center-squeezes** the broad-consensus candidate (eliminated early for too few *firsts*) — Burlington, Alaska. A Condorcet count or STAR elects the consensus; IRV needn't. | [`../00_start_here/concepts/RCV_IRV_center_squeeze.md`](../00_start_here/concepts/RCV_IRV/RCV_IRV_center_squeeze.md) |
| "RCV **ends the spoiler effect** / eliminates vote-splitting." | **Oversold** | It tames the ordinary first-round spoiler, but reintroduces a spoiler-shaped failure via center squeeze: a third candidate's presence can flip the winner (Burlington 2009). | [`../00_start_here/concepts/RCV_IRV_center_squeeze.md`](../00_start_here/concepts/RCV_IRV/RCV_IRV_center_squeeze.md) · [`whats_so_good_about_STAR_Voting.md`](./whats_so_good_about_STAR_Voting.md) |
...
- [`favorite_betrayal_voting_301.md`](./favorite_betrayal_voting_301.md) — "safe to vote
  your conscience."
- [`../00_start_here/concepts/RCV_IRV_is_simple.md`](../00_start_here/concepts/RCV_IRV/RCV_IRV_is_simple.md)
  · [`../00_start_here/concepts/tabulation_star_vs_irv.md`](../00_start_here/concepts/tabulation_star_vs_irv.md)
  — "easy as 1-2-3."
- [`../00_start_here/concepts/RCV_IRV_center_squeeze.md`](../00_start_here/concepts/RCV_IRV/RCV_IRV_center_squeeze.md)
