# RCV-IRV Misconceptions & False Claims — an index

### Voting 201/301 · a routing table from each common claim to its precise rebuttal
...
- **"RCV" names a ranked *ballot*; "IRV" names *one tabulation* of it.** Almost every
  ...
  [`RCV_or_IRV_whats_the_right_word.md`](./RCV_or_IRV_whats_the_right_word.md).)
...
| "RCV is **as easy as 1-2-3** / simple." | **Half-true** | The *ballot* is simple to mark; the *count* is rounds of eliminate-and-transfer — not summable, needs a central tally and software. | [`../00_start_here/concepts/is_rcv_simple.md`](../00_start_here/concepts/is_rcv_simple.md) · [`tabulation_star_vs_irv.md`](../00_start_here/concepts/tabulation_star_vs_irv.md) |
| "RCV is **non-polarizing** / elects the consensus candidate." | **Oversold** | IRV **center-squeezes** the broad-consensus candidate (eliminated early for too few *firsts*) — Burlington, Alaska. A Condorcet count or STAR elects the consensus; IRV needn't. | [`../00_start_here/concepts/center_squeeze.md`](../00_start_here/concepts/center_squeeze.md) |
| "RCV **ends the spoiler effect** / eliminates vote-splitting." | **Oversold** | It tames the ordinary first-round spoiler, but reintroduces a spoiler-shaped failure via center squeeze: a third candidate's presence can flip the winner (Burlington 2009). | [`../00_start_here/concepts/center_squeeze.md`](../00_start_here/concepts/center_squeeze.md) · [`whats_so_good_about_STAR_Voting.md`](./whats_so_good_about_STAR_Voting.md) |
...
| "RCV is **easy to count / audit** (precinct-summable)." | **False** | IRV is **not summable** — who's eliminated depends on the whole electorate, so ballots must be counted centrally and a recount re-runs the rounds. | [`../00_start_here/concepts/summability.md`](../00_start_here/concepts/summability.md) |
| "RCV **breaks two-party domination**." | **Disputed / unproven** | Where IRV has been used longest (Australia's House, a century) two-party dominance persists; center squeeze actively disadvantages the third/center candidate. Treat as an empirical claim, not a given. | [`../00_start_here/concepts/center_squeeze.md`](../00_start_here/concepts/center_squeeze.md) (polarization notes) |
...
the vague word hides. Full taxonomy: [`exhausted_ballots_301.md`](./exhausted_ballots_301.md) §2.
...
- [`favorite_betrayal_voting_301.md`](./favorite_betrayal_voting_301.md) — "safe to vote
  your conscience."
- [`../00_start_here/concepts/is_rcv_simple.md`](../00_start_here/concepts/is_rcv_simple.md)
  · [`../00_start_here/concepts/tabulation_star_vs_irv.md`](../00_start_here/concepts/tabulation_star_vs_irv.md)
  — "easy as 1-2-3."
- [`../00_start_here/concepts/center_squeeze.md`](../00_start_here/concepts/center_squeeze.md)
  · [`../00_start_here/concepts/summability.md`](../00_start_here/concepts/summability.md)
